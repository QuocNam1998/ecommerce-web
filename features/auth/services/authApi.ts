...
export async function forgotPassword(email: string): Promise<void> {
  await sendAuthRequest<AuthResponse>("/auth/forgot-password", {
    method: "POST",
...
export async function resetPassword(token: string, newPassword: string): Promise<void> {
  await sendAuthRequest<AuthResponse>("/auth/reset-password", {
    method: "POST",
...
export function updateProfile(data: {
  ...
  return sendAuthRequest<AuthenticatedUser>("/auth/me", {
    method: "PATCH",
...
export async function deleteAccount(): Promise<void> {
  await sendAuthRequest<void>("/auth/me", {
    method: "DELETE",
    headers: {}
  });
}
